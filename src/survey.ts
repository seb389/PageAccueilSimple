  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          key: "purchase_intent", type: "scale", required: true,
          label: "À partir de 200 $/semaine, utiliseriez-vous un service de location de vélo haut de gamme ?",
          min: 1, max: 4,
          minLabel: "Non",
          maxLabel: "Certainement",
        },
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          key: "purchase_intent", type: "scale", required: true,
          label: "Starting at $200/week, would you use a premium road bike rental service?",
          min: 1, max: 4,
          minLabel: "No",
          maxLabel: "Certainly",
        },
